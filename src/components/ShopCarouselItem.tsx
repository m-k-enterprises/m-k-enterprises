...
const ShopCarouselItem = React.memo(React.forwardRef<HTMLDivElement, { shop: Shop } & Omit<React.ComponentProps<typeof Carousel.Item>, 'children'>>(({ shop, className, style, ...props }, ref) => (
  <Carousel.Item
    ref={ref}
    {...props}
