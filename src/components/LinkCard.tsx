...
/**
 * Render a clickable card representing a link item (logo, description and Visit button).
 *
 * Renders a Bootstrap Card using the provided LinkItem: shows the item's logo (with an accessible alt text fallback using the item's name or "Logo"), displays the description, applies optional background/foreground colours and cover image, and includes a "Visit" button linking to the item's URL.
 *
